/**
 * Реестр свёрнутых FloatingPanel — каждая получает свой слот внизу экрана,
 * мини-бары выстраиваются горизонтально и не наслаиваются.
 */
...
/** Смещение слева (px) для мини-бара по storageKey */
