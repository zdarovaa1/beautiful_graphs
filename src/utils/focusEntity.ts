...
/** Длительность анимации zoom к элементу (ms) */
export const FOCUS_ZOOM_DURATION = 400;
/** Отступ viewport вокруг элемента при фокусе (доля размера) */
export const FOCUS_ZOOM_PADDING = 0.35;
/** Максимальный zoom при фокусе на один элемент */
...
export function useFocusEntity() {
  ...
  return useCallback((entity: SelectedEntity) => {
    void fitView({
